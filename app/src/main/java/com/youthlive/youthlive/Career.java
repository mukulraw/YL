...
public class Career extends Fragment {
    ...
    List<com.youthlive.youthlive.loginResponsePOJO.Career> list;
    EducationAdapter adapter;
    FloatingActionButton add;
    PersonalInfo per;
    String userId;

    public void setData(List<com.youthlive.youthlive.loginResponsePOJO.Career> list)
    {
        this.list = list;
    }
    ...
    public class EducationAdapter extends RecyclerView.Adapter<EducationAdapter.ViewHolder> {
        List<com.youthlive.youthlive.loginResponsePOJO.Career> list = new ArrayList<>();
        Context context;

        public EducationAdapter(Context context, List<com.youthlive.youthlive.loginResponsePOJO.Career> list) {
            this.list = list;
            this.context = context;
        }

        public void setGridData(List<com.youthlive.youthlive.loginResponsePOJO.Career> list) {
            this.list = list;
        ...
        public void onBindViewHolder(ViewHolder holder, int position) {
            ...
            final com.youthlive.youthlive.loginResponsePOJO.Career item = list.get(position);
