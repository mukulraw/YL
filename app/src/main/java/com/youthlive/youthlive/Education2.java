...
import com.youthlive.youthlive.loginResponsePOJO.*;
...
public class Education2 extends Fragment {
    ...
    List<com.youthlive.youthlive.timelineProfilePOJO.Education> list;
    ...
    public void setData(List<com.youthlive.youthlive.timelineProfilePOJO.Education> list)
    {
        this.list = list;
    }
    ...
    public class EducationAdapter extends RecyclerView.Adapter<EducationAdapter.ViewHolder> {
        List<com.youthlive.youthlive.timelineProfilePOJO.Education> list = new ArrayList<>();
        Context context;

        public EducationAdapter(Context context, List<com.youthlive.youthlive.timelineProfilePOJO.Education> list) {
            this.list = list;
            this.context = context;
        }

        public void setGridData(List<com.youthlive.youthlive.timelineProfilePOJO.Education> list) {
            this.list = list;
        ...
        public void onBindViewHolder(ViewHolder holder, int position) {
            ...
            final com.youthlive.youthlive.timelineProfilePOJO.Education item = list.get(position);
