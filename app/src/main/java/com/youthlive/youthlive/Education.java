...
public class Education extends Fragment {
    ...
    List<com.youthlive.youthlive.loginResponsePOJO.Education> list;
    ...
    public void setData(List<com.youthlive.youthlive.loginResponsePOJO.Education> list)
    {
        this.list = list;
    }
    ...
    public class EducationAdapter extends RecyclerView.Adapter<EducationAdapter.ViewHolder> {
        List<com.youthlive.youthlive.loginResponsePOJO.Education> list = new ArrayList<>();
        Context context;

        public EducationAdapter(Context context, List<com.youthlive.youthlive.loginResponsePOJO.Education> list) {
            this.list = list;
            this.context = context;
        }

        public void setGridData(List<com.youthlive.youthlive.loginResponsePOJO.Education> list) {
            this.list = list;
        ...
        public void onBindViewHolder(ViewHolder holder, int position) {
            ...
            final com.youthlive.youthlive.loginResponsePOJO.Education item = list.get(position);
