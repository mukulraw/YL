...
public class Career2 extends Fragment {
    ...
    List<com.youthlive.youthlive.timelineProfilePOJO.Career> list;
    EducationAdapter adapter;
    FloatingActionButton add;
    TimelineProfile per;
    String userId;

    public void setData(List<com.youthlive.youthlive.timelineProfilePOJO.Career> list)
    {
        this.list = list;
    }
    ...
    public class EducationAdapter extends RecyclerView.Adapter<EducationAdapter.ViewHolder> {
        List<com.youthlive.youthlive.timelineProfilePOJO.Career> list = new ArrayList<>();
        Context context;

        public EducationAdapter(Context context, List<com.youthlive.youthlive.timelineProfilePOJO.Career> list) {
            this.list = list;
            this.context = context;
        }

        public void setGridData(List<com.youthlive.youthlive.timelineProfilePOJO.Career> list) {
            this.list = list;
        ...
        public void onBindViewHolder(ViewHolder holder, int position) {
            ...
            com.youthlive.youthlive.timelineProfilePOJO.Career item = list.get(position);
